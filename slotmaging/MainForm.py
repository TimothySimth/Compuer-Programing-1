...
class MainForm(Form):
    ...
    def InitializeComponent(self):
					...
					resources = System.Resources.ResourceManager("slotmaging.MainForm", System.Reflection.Assembly.GetEntryAssembly())
					...
					self._pictureBox4.ErrorImage = None
					self._pictureBox4.Image = resources.GetObject("pictureBox4.Image")
					self._pictureBox4.InitialImage = None
